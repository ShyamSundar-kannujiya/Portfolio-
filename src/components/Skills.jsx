    ...
    >
        <div className='container mx-auto px-6'>
           <h2 className='text-3xl font-bold text-center mb-4'>My
              <p className='text-purple'>Skills</p>
            </h2> 
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto'>
                {
                    skills.map((skill, index) => (
                        ...
                        hover:-translate-y-2 transition duration-300 cuersor-pointer'>
                        <div className='flex items-center mb-4'>
                            ...
                            <div className='flex flex-wrap gap-2'>
                                {skill.tags.map((tech)=>(
                                    <span key={tech} className='px-3 py-1 bg-gray-500 rounded-full text-sm'>{tech}</span>
                                ))}
                            </div>
                        </div>    
                ))
