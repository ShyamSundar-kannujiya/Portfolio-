      ...
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="md:w-1/2 mb-10 md:mb-0 text-white">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">
            Hi, I'm <span className="text-purple-500">Shyam Sundar</span>
          </h1>
          <h2 className="text-2xl md:text-4xl font-semibold mb-6 typewriter">
            Web Developer
          </h2>
          <p className="text-lg text-gray-300 mb-8">
            I build responsive websites with modern technologies.
          </p>
          <div className="flex space-x-4">
            <a
              href="/public/SHYAM_SUNDUR_CV.pdf"
            ...
            <a
              href="#contact"
              className="px-6 py-3 border border-purple-600 rounded-lg font-medium hover:bg-purple-600/20 transition duration-300"
            >
              Contact Me
            </a>
          </div>
        ...
        <div className="md:w-1/2 flex justify-center">
          <div className="relative w-64 h-64 md:w-80 md:h-80">
            ...
            <div className="absolute inset-0 rounded-full bg-gradient-to-r from-purple-500 to-pink opacity-70"></div>
